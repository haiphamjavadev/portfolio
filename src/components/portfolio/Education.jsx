                        ...
                        <div className="grid md:grid-cols-3 gap-8 items-center">
                            ...
                            <div className="md:col-span-2">
                                <div className="flex items-start gap-3 mb-4">
                                    ...
                                    <div>
                                        <h3 className="text-3xl font-black mb-2">Hanoi University of Business and
                                            Technology</h3>
                                        <p className="text-xl text-blue-400 font-bold mb-4">Bachelor of Information
                                            Technology</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-6">
                                    <div className="bg-white/10 backdrop-blur-lg p-4 rounded-xl border border-white/20">
                                        ...
                                        <div className="text-2xl font-bold">2019 - 2023</div>
                                        <div className="text-sm text-gray-400">Duration</div>
                                    </div>
                                    <div className="bg-white/10 backdrop-blur-lg p-4 rounded-xl border border-white/20">
                                        <Award className="text-yellow-400 mb-2" size={24}/>
                                        <div className="text-2xl font-bold">3.33/4.0</div>
                                        <div className="text-sm text-gray-400">GPA Score</div>
                                    </div>
                                </div>

                                <div className="mt-6 flex flex-wrap gap-2">
                                    {["Software Engineering", "Data Structures", "Algorithms", "Database Design", "Web Development"].map((course, idx) => (
                                        <span key={idx}
